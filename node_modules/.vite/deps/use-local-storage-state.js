...
function useLocalStorageState(key, options) {
  ...
  const [defaultServerValue] = (0, import_react.useState)(options == null ? void 0 : options.defaultServerValue);
  return useLocalStorage(key, defaultValue, defaultServerValue, options == null ? void 0 : options.storageSync, serializer == null ? void 0 : serializer.parse, serializer == null ? void 0 : serializer.stringify);
}
